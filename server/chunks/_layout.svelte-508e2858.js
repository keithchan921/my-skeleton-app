import { c as create_ssr_component, v as validate_component, a as add_attribute, e as escape, b as compute_slots, d as subscribe } from './index2-1f2322d7.js';
import { m as modeCurrent, s as setInitialClassState } from './ProgressBar.svelte_svelte_type_style_lang-da1c37ce.js';
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  `;
      ...
      default: () => {
        return `<h1 class="h2 font-bold underline">Svelte Skeleton</h1>`;
      }
    }
  )}`;
});
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="footer"><h2 class="h2 text-center">This is footer</h2></div>`;
});
const LeftSidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="leftsidebar" class="hidden sm:block"><nav class="list-nav"><ul><li><a href="/">Home</a></li>
      <li><a href="/card">Card</a></li>
      <li><a href="/table">Table</a></li>
      <li><a href="/toast">Toast</a></li></ul></nav></div>`;
});
...
//# sourceMappingURL=_layout.svelte-508e2858.js.map

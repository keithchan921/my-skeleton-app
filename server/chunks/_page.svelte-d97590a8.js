import { c as create_ssr_component, v as validate_component, d as subscribe, e as escape, h as each, a as add_attribute, i as assign, j as is_function } from './index2-1f2322d7.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Toast, "Toast").$$render($$result, { position: "tr", duration: 250 }, {}, {})}
<div class="container h-full mx-auto flex flex-col justify-center items-center space-y-5"><div class="card variant-ghost-primary p-4 flex justify-center items-center">Hello World!!!</div>
	<button type="button" class="btn variant-filled">Pop UP!</button>
	<button type="button" class="btn variant-filled">Clear</button></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-d97590a8.js.map
